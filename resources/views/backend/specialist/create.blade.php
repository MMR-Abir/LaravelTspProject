													...
													<form class="form-horizontal" method="post" action="{{route('specialist.store')}}">
                                                      @csrf
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="text" class="form-control" id="exampleInputuname_4" name="specialist" placeholder="Username">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<textarea type="text" class="form-control" id="exampleInputEmail_4" name="details" rows="10" placeholder="Enter details"></textarea>
