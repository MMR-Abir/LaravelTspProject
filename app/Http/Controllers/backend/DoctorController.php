...
$photo = 'images/nophoto.png';
       ...
       $doctor->save();
       return redirect()->route('doctor.index')->with('msg','Successfully Created');
    }
    ...
    $photo =$doctor->name;
       ...
       $doctor->update();
       return redirect()->route('doctor.index')->with('msg','Updated');
    }
    ...
    {
        $doctor->delete();
        return redirect()->route('doctor.index')->with('msg','Delected');
    }
}
